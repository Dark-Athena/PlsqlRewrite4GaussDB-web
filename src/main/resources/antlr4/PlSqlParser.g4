...
qualified_template_clause
    : ATTRIBUTES ('('|WIDTH_LEFT_PAREN) redundancy_clause? striping_clause? (')'|WIDTH_RIGHT_PAREN) //inconsistent documentation
    ;
...
modify_diskgroup_file
    : MODIFY FILE CHAR_STRING ATTRIBUTE ('('|WIDTH_LEFT_PAREN) disk_region_clause (')'|WIDTH_RIGHT_PAREN) (
        ',' CHAR_STRING ATTRIBUTE ('('|WIDTH_LEFT_PAREN) disk_region_clause (')'|WIDTH_RIGHT_PAREN)
    )*
    ;
...
alter_java
    : ALTER JAVA (SOURCE | CLASS) (schema_name '.')? o = id_expression (
        RESOLVER ('('|WIDTH_LEFT_PAREN) (('('|WIDTH_LEFT_PAREN) match_string ','? (schema_name | '-') (')'|WIDTH_RIGHT_PAREN))+ (')'|WIDTH_RIGHT_PAREN)
...
create_function_body
    : CREATE (OR REPLACE)? (EDITIONABLE | NONEDITIONABLE)? FUNCTION function_name (
        ('('|WIDTH_LEFT_PAREN) parameter (',' parameter)* (')'|WIDTH_RIGHT_PAREN)
...
partition_by_clause
    : ('('|WIDTH_LEFT_PAREN) PARTITION expression BY (ANY | (HASH | RANGE | LIST) paren_column_list) streaming_clause? (')'|WIDTH_RIGHT_PAREN)
    ;

result_cache_clause
    : RESULT_CACHE relies_on_part? (('('|WIDTH_LEFT_PAREN) MODE (DEFAULT | FORCE ) (')'|WIDTH_RIGHT_PAREN))?
    ;

accessible_by_clause
    : ACCESSIBLE BY ('('|WIDTH_LEFT_PAREN) accessor (',' accessor)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
relies_on_part
    : RELIES_ON ('('|WIDTH_LEFT_PAREN) tableview_name (',' tableview_name)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
lockdown_feature
    : disable_enable FEATURE ('=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN) | ALL (EXCEPT '=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN))?)
    ;

lockdown_options
    : disable_enable OPTION ('=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN) | ALL (EXCEPT '=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN))?)
    ;

lockdown_statements
    : disable_enable STATEMENT (
        '=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN)
        | '=' ('('|WIDTH_LEFT_PAREN) CHAR_STRING (')'|WIDTH_RIGHT_PAREN) statement_clauses
        | ALL (EXCEPT '=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN))?
    )
    ;
...
statement_clauses
    : CLAUSE (
        '=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN)
        | '=' ('('|WIDTH_LEFT_PAREN) CHAR_STRING (')'|WIDTH_RIGHT_PAREN) clause_options
        | ALL (EXCEPT '=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN))?
    )
    ;
...
clause_options
    : OPTION (
        '=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN)
        | '=' ('('|WIDTH_LEFT_PAREN) CHAR_STRING (')'|WIDTH_RIGHT_PAREN) option_values+
        | ALL (EXCEPT '=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN))?
    )
    ;

option_values
    : VALUE '=' ('('|WIDTH_LEFT_PAREN) string_list (')'|WIDTH_RIGHT_PAREN)
...
procedure_spec
    : PROCEDURE identifier (('('|WIDTH_LEFT_PAREN) parameter ( ',' parameter)* (')'|WIDTH_RIGHT_PAREN))? (
        accessible_by_clause
        | PARALLEL_ENABLE
    )* ';'
    ;
...
function_spec
    : FUNCTION identifier (('('|WIDTH_LEFT_PAREN) parameter ( ',' parameter)* (')'|WIDTH_RIGHT_PAREN))? RETURN type_spec (
        DETERMINISTIC
        | IMMUTABLE
        | PIPELINED
        | parallel_enable_clause
...
create_procedure_body
    : CREATE (OR REPLACE)? PROCEDURE procedure_name (('('|WIDTH_LEFT_PAREN) parameter (',' parameter)* (')'|WIDTH_RIGHT_PAREN))? invoker_rights_clause? PARALLEL_ENABLE? (
        IS
        | AS
...
trigger_when_clause
    : WHEN ('('|WIDTH_LEFT_PAREN) condition (')'|WIDTH_RIGHT_PAREN)
    ;
...
replace_type_clause
    : REPLACE invoker_rights_clause? AS OBJECT ('('|WIDTH_LEFT_PAREN) object_member_spec (',' object_member_spec)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
alter_attribute_definition
    : (ADD | MODIFY | DROP) ATTRIBUTE (
        ...
        | ('('|WIDTH_LEFT_PAREN) attribute_definition (',' attribute_definition)* (')'|WIDTH_RIGHT_PAREN)
    )
    ;
...
object_type_def
    : invoker_rights_clause? (object_as_part | object_under_part) sqlj_object_type? (
        ('('|WIDTH_LEFT_PAREN) object_member_spec (',' object_member_spec)* (')'|WIDTH_RIGHT_PAREN)
    )? modifier_clause*
    ;
...
proc_decl_in_type
    : PROCEDURE procedure_name ('('|WIDTH_LEFT_PAREN) type_elements_parameter (',' type_elements_parameter)* (')'|WIDTH_RIGHT_PAREN) (
        IS
        | AS
...
func_decl_in_type
    : FUNCTION function_name (('('|WIDTH_LEFT_PAREN) type_elements_parameter (',' type_elements_parameter)* (')'|WIDTH_RIGHT_PAREN))? RETURN type_spec (
        IS
        | AS
    ) (call_spec | DECLARE? seq_of_declare_specs? body ';')
    ;
...
constructor_declaration
    : FINAL? INSTANTIABLE? CONSTRUCTOR FUNCTION type_spec (
        ('('|WIDTH_LEFT_PAREN) (SELF IN OUT type_spec ',') type_elements_parameter (',' type_elements_parameter)* (')'|WIDTH_RIGHT_PAREN)
...
overriding_function_spec
    : FUNCTION function_name (('('|WIDTH_LEFT_PAREN) type_elements_parameter (',' type_elements_parameter)* (')'|WIDTH_RIGHT_PAREN))? RETURN (
        type_spec
        | SELF AS RESULT
...
pragma_clause
    : PRAGMA RESTRICT_REFERENCES ('('|WIDTH_LEFT_PAREN) pragma_elements (',' pragma_elements)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
variablesetstmt
    : SET parameter_name (TO | '=') (parameter_value| ON | OFF | TRUE | FALSE)
    ;
...
dim_by_clause
    : DIMENSION BY ('('|WIDTH_LEFT_PAREN) dim_key (',' dim_key)* (')'|WIDTH_RIGHT_PAREN)
    ;

dim_key
    : dim_ref classification_clause* KEY (
        ('('|WIDTH_LEFT_PAREN) (a = id_expression '.')? f = column_name (',' (a = id_expression '.')? f = column_name)* (')'|WIDTH_RIGHT_PAREN)
        | (a = id_expression '.')? f = column_name
    ) REFERENCES DISTINCT? (('('|WIDTH_LEFT_PAREN) attribute_name (',' attribute_name) (')'|WIDTH_RIGHT_PAREN) | attribute_name) HIERARCHIES ('('|WIDTH_LEFT_PAREN) hier_ref (
        ',' hier_ref
    )* (')'|WIDTH_RIGHT_PAREN)
    ;
...
measures_clause
    : MEASURES ('('|WIDTH_LEFT_PAREN) av_measure (',' av_measure)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
calc_meas_clause
    : /*m=id_expression*/ AS ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN) //FIXME inconsistent documentation
    ;
...
cache_specification
    : MEASURE GROUP (
        ALL
        | ('('|WIDTH_LEFT_PAREN) id_expression (',' id_expression)* (')'|WIDTH_RIGHT_PAREN) levels_clause (',' levels_clause)*
    )
    ;

levels_clause
    : LEVELS ('('|WIDTH_LEFT_PAREN) level_specification (',' level_specification)* (')'|WIDTH_RIGHT_PAREN) level_group_type
    ;

level_specification
    : ('('|WIDTH_LEFT_PAREN) ((d = id_expression '.')? h = id_expression '.')? l = id_expression (')'|WIDTH_RIGHT_PAREN)
    ;
...
attributes_clause
    : ATTRIBUTES ('('|WIDTH_LEFT_PAREN) ad_attributes_clause (',' ad_attributes_clause)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
ad_level_clause
    ...
    key_clause alternate_key_clause? (MEMBER NAME expression)? (MEMBER CAPTION expression)? (
        ...
        DETERMINES ('('|WIDTH_LEFT_PAREN) id_expression (',' id_expression)* (')'|WIDTH_RIGHT_PAREN)
    )?
    ;

key_clause
    : KEY (a = id_expression | ('('|WIDTH_LEFT_PAREN) id_expression (',' id_expression)* (')'|WIDTH_RIGHT_PAREN))
    ;
...
level_hier_clause
    : ('('|WIDTH_LEFT_PAREN) (l = id_expression (CHILD OF)?)+ (')'|WIDTH_RIGHT_PAREN)
    ;

hier_attrs_clause
    : HIERARCHICAL ATTRIBUTES ('('|WIDTH_LEFT_PAREN) hier_attr_clause (')'|WIDTH_RIGHT_PAREN)
    ;
...
table_index_clause
    : tableview_name table_alias? ('('|WIDTH_LEFT_PAREN) index_expr (ASC | DESC)? (',' index_expr (ASC | DESC)?)* (')'|WIDTH_RIGHT_PAREN) index_properties?
    ;

bitmap_join_index_clause
    : tableview_name ('('|WIDTH_LEFT_PAREN) (tableview_name | table_alias)? column_name (ASC | DESC)? (
        ',' (tableview_name | table_alias)? column_name (ASC | DESC)?
    )* (')'|WIDTH_RIGHT_PAREN) FROM tableview_name table_alias (',' tableview_name table_alias)* where_clause local_partitioned_index? index_attributes?
    ;
...
domain_index_clause
    : indextype local_domain_index_clause? parallel_clause? (PARAMETERS ('('|WIDTH_LEFT_PAREN) odci_parameters (')'|WIDTH_RIGHT_PAREN))?
    ;

local_domain_index_clause
    : LOCAL (
        ('('|WIDTH_LEFT_PAREN) PARTITION partition_name (PARAMETERS ('('|WIDTH_LEFT_PAREN) odci_parameters (')'|WIDTH_RIGHT_PAREN))? (
            ',' PARTITION partition_name (PARAMETERS ('('|WIDTH_LEFT_PAREN) odci_parameters (')'|WIDTH_RIGHT_PAREN))?
        )* (')'|WIDTH_RIGHT_PAREN)
    )?
    ;
...
local_xmlindex_clause
    : LOCAL (
        ('('|WIDTH_LEFT_PAREN) PARTITION partition_name (
...
global_partitioned_index
    : GLOBAL PARTITION BY (
        RANGE ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN) ('('|WIDTH_LEFT_PAREN) index_partitioning_clause (
            ',' index_partitioning_clause
        )* (')'|WIDTH_RIGHT_PAREN)
        | HASH ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN) (
...
index_partitioning_clause
    : PARTITION partition_name? VALUES LESS THAN ('('|WIDTH_LEFT_PAREN) index_partitioning_values_list (')'|WIDTH_RIGHT_PAREN) segment_attributes_clause?
    ;
...
on_range_partitioned_table
    : ('('|WIDTH_LEFT_PAREN) partitioned_table (',' partitioned_table)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
on_hash_partitioned_table
    : STORE IN ('('|WIDTH_LEFT_PAREN) tablespace (',' tablespace)* (')'|WIDTH_RIGHT_PAREN)
    | ('('|WIDTH_LEFT_PAREN) on_hash_partitioned_clause (',' on_hash_partitioned_clause)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
on_comp_partitioned_table
    : (STORE IN ('('|WIDTH_LEFT_PAREN) tablespace (',' tablespace)* (')'|WIDTH_RIGHT_PAREN))? ('('|WIDTH_LEFT_PAREN) on_comp_partitioned_clause (
...
index_subpartition_clause
    : STORE IN ('('|WIDTH_LEFT_PAREN) tablespace (',' tablespace)* (')'|WIDTH_RIGHT_PAREN)
    | ('('|WIDTH_LEFT_PAREN) index_subpartition_subclause (',' index_subpartition_subclause)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
alter_index_ops_set2
    : rebuild_clause
    | PARAMETERS ('('|WIDTH_LEFT_PAREN) odci_parameters (')'|WIDTH_RIGHT_PAREN)
    | COMPILE
    | enable_or_disable
    | UNUSABLE
...
split_index_partition
    : SPLIT PARTITION partition_name_old AT ('('|WIDTH_LEFT_PAREN) literal (',' literal)* (')'|WIDTH_RIGHT_PAREN) (
        INTO ('('|WIDTH_LEFT_PAREN) index_partition_description ',' index_partition_description (')'|WIDTH_RIGHT_PAREN)
    )? parallel_clause?
    ;
...
alter_inmemory_join_group
    : ALTER INMEMORY JOIN GROUP (schema_name '.')? jg = id_expression (ADD | REMOVE) ('('|WIDTH_LEFT_PAREN) (
        schema_name '.'
    )? t = id_expression ('('|WIDTH_LEFT_PAREN) c = id_expression (')'|WIDTH_RIGHT_PAREN) (')'|WIDTH_RIGHT_PAREN)
    ;
...
export_keys
    : EXPORT ENCRYPTION? KEYS WITH SECRET secret TO filename force_keystore? identified_by_store (
        WITH IDENTIFIER IN (CHAR_STRING (',' CHAR_STRING)* | ('('|WIDTH_LEFT_PAREN) subquery (')'|WIDTH_RIGHT_PAREN))
    )?
    ;
...
partition_extention_clause
    : PARTITION (
        ('('|WIDTH_LEFT_PAREN) partition_name (')'|WIDTH_RIGHT_PAREN)
        | FOR ('('|WIDTH_LEFT_PAREN) partition_key_value (',' partition_key_value)* (')'|WIDTH_RIGHT_PAREN)
    )
    | SUBPARTITION (
        ('('|WIDTH_LEFT_PAREN) subpartition_name (')'|WIDTH_RIGHT_PAREN)
        | FOR ('('|WIDTH_LEFT_PAREN) subpartition_key_value (',' subpartition_key_value)* (')'|WIDTH_RIGHT_PAREN)
    )
    ;
...
default_cost_clause
    : DEFAULT COST ('('|WIDTH_LEFT_PAREN) cpu_cost ',' io_cost ',' network_cost (')'|WIDTH_RIGHT_PAREN)
    ;
...
create_inmemory_join_group
    : CREATE INMEMORY JOIN GROUP (schema_name '.')? jg = id_expression ('('|WIDTH_LEFT_PAREN) (schema_name '.')? t = id_expression ('('|WIDTH_LEFT_PAREN) c = id_expression (')'|WIDTH_RIGHT_PAREN) (
        ',' (schema_name '.')? t = id_expression ('('|WIDTH_LEFT_PAREN) c = id_expression (')'|WIDTH_RIGHT_PAREN)
    )+ (')'|WIDTH_RIGHT_PAREN)
    ;
...
create_java
    : CREATE (OR REPLACE)? (AND (RESOLVE | COMPILE))? NOFORCE? JAVA (
        ...
        RESOLVER ('('|WIDTH_LEFT_PAREN) (('('|WIDTH_LEFT_PAREN) CHAR_STRING ','? (sn = id_expression | '-') (')'|WIDTH_RIGHT_PAREN))+ (')'|WIDTH_RIGHT_PAREN)
    )? (
        USING (
            BFILE ('('|WIDTH_LEFT_PAREN) d = id_expression ',' filename (')'|WIDTH_RIGHT_PAREN)
...
level_clause
    : LEVEL identifier IS (
        ...
        | ('('|WIDTH_LEFT_PAREN) table_name '.' column_name (',' table_name '.' column_name)* (')'|WIDTH_RIGHT_PAREN)
    ) (SKIP_ WHEN NULL_)?
    ;

hierarchy_clause
    : HIERARCHY identifier ('('|WIDTH_LEFT_PAREN) identifier (CHILD OF identifier)+ dimension_join_clause? (')'|WIDTH_RIGHT_PAREN)
    ;
...
column_one_or_more_sub_clause
    : column_name
    | ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
alter_view
    : ALTER VIEW tableview_name (
        ...
        | DROP (
            ...
            | PRIMARY KEY
            | UNIQUE ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN)
        )
        | COMPILE
        | READ (ONLY | WRITE)
...
view_alias_constraint
    : ('('|WIDTH_LEFT_PAREN) (','? (table_alias inline_constraint* | out_of_line_constraint))+ (')'|WIDTH_RIGHT_PAREN)
    ;

object_view_clause
    : OF (schema_name '.')? tn = id_expression (
        WITH OBJECT (IDENTIFIER | ID) (DEFAULT | ('('|WIDTH_LEFT_PAREN) REGULAR_ID (',' REGULAR_ID)* (')'|WIDTH_RIGHT_PAREN))
        | UNDER (schema_name '.')? sv = id_expression
    ) (('('|WIDTH_LEFT_PAREN) (','? (out_of_line_constraint | REGULAR_ID inline_constraint))+ (')'|WIDTH_RIGHT_PAREN))*
    ;
...
out_of_line_ref_constraint
    : SCOPE FOR ('('|WIDTH_LEFT_PAREN) ref_col_or_attr = regular_id (')'|WIDTH_RIGHT_PAREN) IS tableview_name
    | REF ('('|WIDTH_LEFT_PAREN) ref_col_or_attr = regular_id (')'|WIDTH_RIGHT_PAREN) WITH ROWID
    | (CONSTRAINT constraint_name)? FOREIGN KEY ('('|WIDTH_LEFT_PAREN) (','? ref_col_or_attr = regular_id)+ (')'|WIDTH_RIGHT_PAREN) references_clause constraint_state?
    ;
...
out_of_line_constraint
    : (
        ((CONSTRAINT | CONSTRAINTS) constraint_name)? (
            UNIQUE ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN)
            | PRIMARY KEY ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN)
            | foreign_key_clause
            | CHECK ('('|WIDTH_LEFT_PAREN) condition (')'|WIDTH_RIGHT_PAREN)
        )
    )
    constraint_state?
    parallel_clause?
...
xmltype_view_clause
    : OF XMLTYPE xml_schema_spec? WITH OBJECT (IDENTIFIER | ID) (
        DEFAULT
        | ('('|WIDTH_LEFT_PAREN) expression (',' expression)* (')'|WIDTH_RIGHT_PAREN)
    )
    ;
...
create_tablespace_set
    : CREATE TABLESPACE SET tss = id_expression (IN SHARDSPACE ss = id_expression)? (
        USING TEMPLATE ('('|WIDTH_LEFT_PAREN) (DATAFILE file_specification (',' file_specification)*)? permanent_tablespace_attrs+ (')'|WIDTH_RIGHT_PAREN)
    )?
    ;
...
inmmemory_clause
    : INMEMORY inmemory_attributes? (
        TEXT (
            column_name ((','|WIDTH_COMMA) column_name)*
...
redo_log_file_spec
    : (filename | ('('|WIDTH_LEFT_PAREN) filename (',' filename)* (')'|WIDTH_RIGHT_PAREN)) (SIZE size_clause)? (BLOCKSIZE size_clause)? REUSE?
    ;
...
modify_mv_column_clause
    : MODIFY ('('|WIDTH_LEFT_PAREN) column_name (ENCRYPT encryption_spec | DECRYPT)? (')'|WIDTH_RIGHT_PAREN)
    ;
...
add_mv_log_column_clause
    : ADD ('('|WIDTH_LEFT_PAREN) column_name (')'|WIDTH_RIGHT_PAREN)
    ;
...
mv_log_augmentation
    : ADD (
        (OBJECT ID | PRIMARY KEY | ROWID | SEQUENCE) (('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN))?
        | ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN)
    ) new_values_clause?
    ;
...
create_materialized_view_log
    ...
    (
        WITH (','? ( OBJECT ID | PRIMARY KEY | ROWID | SEQUENCE | COMMIT SCN))* (
            ('('|WIDTH_LEFT_PAREN) ( ','? regular_id)+ (')'|WIDTH_RIGHT_PAREN) new_values_clause?
        )? mv_log_purge_clause?
    )*
    ;
...
create_materialized_view
    : CREATE MATERIALIZED VIEW tableview_name (OF type_name)? (
        ('('|WIDTH_LEFT_PAREN) (scoped_table_ref_constraint | mv_column_alias) (
...
scoped_table_ref_constraint
    : SCOPE FOR ('('|WIDTH_LEFT_PAREN) ref_column_or_attribute = identifier (')'|WIDTH_RIGHT_PAREN) IS (schema_name '.')? scope_table_name_or_c_alias = identifier
    ;
...
create_cluster
    : CREATE CLUSTER cluster_name ('('|WIDTH_LEFT_PAREN) column_name datatype SORT? (',' column_name datatype SORT?)* (')'|WIDTH_RIGHT_PAREN) (
        physical_attributes_clause
        | SIZE size_clause
        | TABLESPACE tablespace
        | INDEX
...
xmltype_table
    : OF XMLTYPE (('('|WIDTH_LEFT_PAREN) object_properties (')'|WIDTH_RIGHT_PAREN))? (XMLTYPE xmltype_storage)? xmlschema_spec? xmltype_virtual_columns? (
        ON COMMIT (DELETE | PRESERVE) ROWS
    )? oid_clause? oid_index_clause? physical_properties? table_properties
    ;

xmltype_virtual_columns
    : VIRTUAL COLUMNS ('('|WIDTH_LEFT_PAREN) column_name AS ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN) (',' column_name AS ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN))* (')'|WIDTH_RIGHT_PAREN)
    ;
...
xmltype_storage
    : STORE AS (
        ...
        | (SECUREFILE | BASICFILE)? (CLOB | BINARY XML) (
            lob_segname (('('|WIDTH_LEFT_PAREN) lob_parameters (')'|WIDTH_RIGHT_PAREN))?
            | ('('|WIDTH_LEFT_PAREN) lob_parameters (')'|WIDTH_RIGHT_PAREN)
        )?
    )
...
object_table
    : OF (schema_name '.')? object_type object_table_substitution? (
        ('('|WIDTH_LEFT_PAREN) object_properties (',' object_properties)* (')'|WIDTH_RIGHT_PAREN)
...
oid_index_clause
    : OIDINDEX index_name? ('('|WIDTH_LEFT_PAREN) (physical_attributes_clause | TABLESPACE tablespace)+ (')'|WIDTH_RIGHT_PAREN)
    ;
...
relational_table
    : (('('|WIDTH_LEFT_PAREN) relational_property (',' relational_property)* (')'|WIDTH_RIGHT_PAREN))? immutable_table_clauses blockchain_table_clauses? (
...
clustering_join_item
    : JOIN (schema_name '.')? table_name ON ('('|WIDTH_LEFT_PAREN) equijoin_condition (')'|WIDTH_RIGHT_PAREN)
    ;
...
clustering_columns
    ...
    | ('('|WIDTH_LEFT_PAREN) clustering_column_group (',' clustering_column_group)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
zonemap_clause
    : WITH MATERIALIZED ZONEMAP (('('|WIDTH_LEFT_PAREN) zonemap_name (')'|WIDTH_RIGHT_PAREN))?
...
range_partitions
    : PARTITION BY RANGE ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN) (
        INTERVAL ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN) (STORE IN ('('|WIDTH_LEFT_PAREN) tablespace (',' tablespace)* (')'|WIDTH_RIGHT_PAREN))?
    )? ('('|WIDTH_LEFT_PAREN) PARTITION partition_name? range_values_clause table_partition_description (
        ',' PARTITION partition_name? range_values_clause table_partition_description
    )* (')'|WIDTH_RIGHT_PAREN)
    ;

list_partitions
    : PARTITION BY LIST ('('|WIDTH_LEFT_PAREN) column_name (')'|WIDTH_RIGHT_PAREN) ('('|WIDTH_LEFT_PAREN) PARTITION partition_name? list_values_clause table_partition_description (
        ',' PARTITION partition_name? list_values_clause table_partition_description
    )* (')'|WIDTH_RIGHT_PAREN)
    ;

hash_partitions
    : PARTITION BY HASH ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN) (
        individual_hash_partitions
        | hash_partitions_by_quantity
    )
    ;
...
individual_hash_partitions
    : ('('|WIDTH_LEFT_PAREN) PARTITION partition_name? partitioning_storage_clause? (
        ',' PARTITION partition_name? partitioning_storage_clause?
    )* (')'|WIDTH_RIGHT_PAREN)
    ;

hash_partitions_by_quantity
    : PARTITIONS hash_partition_quantity (STORE IN ('('|WIDTH_LEFT_PAREN) tablespace (',' tablespace)* (')'|WIDTH_RIGHT_PAREN))? (
        table_compression
        | key_compression
    )? (OVERFLOW STORE IN ('('|WIDTH_LEFT_PAREN) tablespace (',' tablespace)* (')'|WIDTH_RIGHT_PAREN))?
    ;
...
composite_range_partitions
    : PARTITION BY RANGE ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN) (
        INTERVAL ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN) (STORE IN ('('|WIDTH_LEFT_PAREN) tablespace (',' tablespace)* (')'|WIDTH_RIGHT_PAREN))?
    )? (subpartition_by_range | subpartition_by_list | subpartition_by_hash) ('('|WIDTH_LEFT_PAREN) range_partition_desc (
        ',' range_partition_desc
    )* (')'|WIDTH_RIGHT_PAREN)
    ;

composite_list_partitions
    : PARTITION BY LIST ('('|WIDTH_LEFT_PAREN) column_name (')'|WIDTH_RIGHT_PAREN) (
        subpartition_by_range
        | subpartition_by_list
        | subpartition_by_hash
    ) ('('|WIDTH_LEFT_PAREN) list_partition_desc (',' list_partition_desc)* (')'|WIDTH_RIGHT_PAREN)
    ;

composite_hash_partitions
    : PARTITION BY HASH ('('|WIDTH_LEFT_PAREN) (',' column_name)+ (')'|WIDTH_RIGHT_PAREN) (
        subpartition_by_range
        | subpartition_by_list
        | subpartition_by_hash
...
reference_partitioning
    : PARTITION BY REFERENCE ('('|WIDTH_LEFT_PAREN) regular_id (')'|WIDTH_RIGHT_PAREN) (
        ('('|WIDTH_LEFT_PAREN) reference_partition_desc (',' reference_partition_desc)* (')'|WIDTH_RIGHT_PAREN)
    )?
    ;
...
subpartition_by_range
    : SUBPARTITION BY RANGE ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN) subpartition_template?
    ;

subpartition_by_list
    : SUBPARTITION BY LIST ('('|WIDTH_LEFT_PAREN) column_name (')'|WIDTH_RIGHT_PAREN) subpartition_template?
    ;

subpartition_by_hash
    : SUBPARTITION BY HASH ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN) (
        SUBPARTITIONS UNSIGNED_INTEGER (STORE IN ('('|WIDTH_LEFT_PAREN) tablespace (',' tablespace)* (')'|WIDTH_RIGHT_PAREN))?
        | subpartition_template
    )?
    ;
...
range_values_clause
    : VALUES LESS THAN ('('|WIDTH_LEFT_PAREN) range_values_list (')'|WIDTH_RIGHT_PAREN)
    ;
...
list_values_clause
    : VALUES ('('|WIDTH_LEFT_PAREN) (literal (',' literal)* | TIMESTAMP literal (',' TIMESTAMP literal)* | DEFAULT) (')'|WIDTH_RIGHT_PAREN)
    ;
...
lob_partitioning_storage
    : LOB ('('|WIDTH_LEFT_PAREN) lob_item (')'|WIDTH_RIGHT_PAREN) STORE AS (BASICFILE | SECUREFILE)? (
        lob_segname (('('|WIDTH_LEFT_PAREN) TABLESPACE tablespace (')'|WIDTH_RIGHT_PAREN))?
        | ('('|WIDTH_LEFT_PAREN) TABLESPACE tablespace (')'|WIDTH_RIGHT_PAREN)
    )
    ;
...
inmemory_column_clause
    : (INMEMORY inmemory_memcompress? | NO INMEMORY) ('('|WIDTH_LEFT_PAREN) column_list (')'|WIDTH_RIGHT_PAREN)
    ;
...
physical_properties
    ...
    | CLUSTER cluster_name ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
external_table_clause
    : ('('|WIDTH_LEFT_PAREN) (TYPE access_driver_type)? external_table_data_props (')'|WIDTH_RIGHT_PAREN) (
...
external_table_data_props
    : (DEFAULT DIRECTORY directory_name)? (
        ACCESS PARAMETERS (
            ('('|WIDTH_LEFT_PAREN) CHAR_STRING (')'|WIDTH_RIGHT_PAREN)
            | ('('|WIDTH_LEFT_PAREN) opaque_format_spec (')'|WIDTH_RIGHT_PAREN)
            | USING CLOB select_only_statement
        )
    )? (LOCATION ('('|WIDTH_LEFT_PAREN) directory_name COLON CHAR_STRING (',' directory_name COLON CHAR_STRING)* (')'|WIDTH_RIGHT_PAREN))?
    ;
...
supplemental_log_grp_clause
    : GROUP log_grp ('('|WIDTH_LEFT_PAREN) regular_id (NO LOG)? (',' regular_id (NO LOG)?)* (')'|WIDTH_RIGHT_PAREN) ALWAYS?
    ;

supplemental_id_key_clause
    : DATA ('('|WIDTH_LEFT_PAREN) (','? ( ALL | PRIMARY KEY | UNIQUE | FOREIGN KEY))+ (')'|WIDTH_RIGHT_PAREN) COLUMNS
    ;
...
alter_add_cache_clause
    : ADD CACHE MEASURE GROUP ('('|WIDTH_LEFT_PAREN) (ALL | measure_list)? (')'|WIDTH_RIGHT_PAREN) LEVELS ('('|WIDTH_LEFT_PAREN) levels_item (
        ',' levels_item
    )* (')'|WIDTH_RIGHT_PAREN)
    ;
...
alter_drop_cache_clause
    : DROP CACHE MEASURE GROUP ('('|WIDTH_LEFT_PAREN) (ALL | measure_list)? (')'|WIDTH_RIGHT_PAREN) LEVELS ('('|WIDTH_LEFT_PAREN) levels_item (
        ',' levels_item
    )* (')'|WIDTH_RIGHT_PAREN)
    ;
...
logfile_descriptor
    ...
    | ('('|WIDTH_LEFT_PAREN) filename (',' filename)* (')'|WIDTH_RIGHT_PAREN)
    | filename
    ;
...
file_name_convert
    : FILE_NAME_CONVERT EQUALS_OP (
        ('('|WIDTH_LEFT_PAREN) filename_convert_sub_clause (',' filename_convert_sub_clause)* (')'|WIDTH_RIGHT_PAREN)
        | NONE
    )
    ;
...
ts_file_name_convert
    : FILE_NAME_CONVERT '=' ('('|WIDTH_LEFT_PAREN) CHAR_STRING ',' CHAR_STRING (',' CHAR_STRING ',' CHAR_STRING)* (')'|WIDTH_RIGHT_PAREN) KEEP?
    ;
...
split_table_partition
    : SPLIT partition_extended_names (
        AT ('('|WIDTH_LEFT_PAREN) literal (',' literal)* (')'|WIDTH_RIGHT_PAREN) INTO ('('|WIDTH_LEFT_PAREN) range_partition_desc (',' range_partition_desc)* (')'|WIDTH_RIGHT_PAREN)
        | INTO ('('|WIDTH_LEFT_PAREN) (
...
alter_interval_partition
    : SET INTERVAL ('('|WIDTH_LEFT_PAREN) (constant | expression)? (')'|WIDTH_RIGHT_PAREN)
    ;

partition_extended_names
    : (PARTITION | PARTITIONS) (
        partition_name (',' partition_name)*
        | ('('|WIDTH_LEFT_PAREN) partition_name (',' partition_name)* (')'|WIDTH_RIGHT_PAREN)
        | FOR ('('|WIDTH_LEFT_PAREN)? partition_key_value (',' partition_key_value)* (')'|WIDTH_RIGHT_PAREN)?
    )
    ;
...
alter_table_properties_1
    : (
        ...
        | deallocate_unused_clause
        | (CACHE | NOCACHE)
        | RESULT_CACHE ('('|WIDTH_LEFT_PAREN) MODE (DEFAULT | FORCE) (')'|WIDTH_RIGHT_PAREN)
        | upgrade_table_clause
        | records_per_block_clause
        | parallel_clause
        | row_movement_clause
...
add_overflow_clause
    : ADD OVERFLOW segment_attributes_clause? (
        ('('|WIDTH_LEFT_PAREN) PARTITION segment_attributes_clause? (',' PARTITION segment_attributes_clause?)* (')'|WIDTH_RIGHT_PAREN)
    )?
    ;
...
update_all_indexes_clause
    : UPDATE INDEXES (('('|WIDTH_LEFT_PAREN) update_all_indexes_index_clause (')'|WIDTH_RIGHT_PAREN))?
    ;

update_all_indexes_index_clause
    : index_name ('('|WIDTH_LEFT_PAREN) (update_index_partition | update_index_subpartition) (')'|WIDTH_RIGHT_PAREN) (
        ',' update_all_indexes_clause
    )*
    ;
...
using_index_clause
    : USING INDEX (index_name | ('('|WIDTH_LEFT_PAREN) create_index (')'|WIDTH_RIGHT_PAREN) | index_attributes)?
    ;
...
drop_column_clause
    : SET UNUSED (COLUMN column_name | (('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN))) (
        CASCADE CONSTRAINTS
        | INVALIDATE
    )*
    | DROP (COLUMN column_name | ('('|WIDTH_LEFT_PAREN) column_name ((','|WIDTH_COMMA) column_name)* (')'|WIDTH_RIGHT_PAREN)) (
        CASCADE CONSTRAINTS
        | INVALIDATE
...
modify_column_clauses
    : MODIFY (
        ('('|WIDTH_LEFT_PAREN) modify_col_properties (',' modify_col_properties)* (')'|WIDTH_RIGHT_PAREN)
        | ('('|WIDTH_LEFT_PAREN) modify_col_visibility (',' modify_col_visibility)* (')'|WIDTH_RIGHT_PAREN)
...
add_column_clause
    : ADD (
        ('('|WIDTH_LEFT_PAREN) (column_definition | virtual_column_definition) (
...
alter_varray_col_properties
    : MODIFY VARRAY varray_item ('('|WIDTH_LEFT_PAREN) modify_lob_parameters (')'|WIDTH_RIGHT_PAREN)
    ;
...
varray_storage_clause
    : STORE AS (SECUREFILE | BASICFILE)? LOB (
        lob_segname? ('('|WIDTH_LEFT_PAREN) lob_storage_parameters (')'|WIDTH_RIGHT_PAREN)
        | lob_segname
    )
    ;
...
lob_storage_clause
    : LOB (
        ('('|WIDTH_LEFT_PAREN) lob_item (',' lob_item)* (')'|WIDTH_RIGHT_PAREN) STORE AS (
            (SECUREFILE | BASICFILE)
            | ('('|WIDTH_LEFT_PAREN) lob_storage_parameters* (')'|WIDTH_RIGHT_PAREN)
        )+
        | ('('|WIDTH_LEFT_PAREN) lob_item (')'|WIDTH_RIGHT_PAREN) STORE AS (
            (SECUREFILE | BASICFILE)
            | lob_segname
            | ('('|WIDTH_LEFT_PAREN) lob_storage_parameters* (')'|WIDTH_RIGHT_PAREN)
        )+
...
modify_lob_storage_clause
    : MODIFY LOB ('('|WIDTH_LEFT_PAREN) lob_item (')'|WIDTH_RIGHT_PAREN) ('('|WIDTH_LEFT_PAREN) modify_lob_parameters (')'|WIDTH_RIGHT_PAREN)
    ;
...
column_properties
    : (
        ...
        | (varray_col_properties | lob_storage_clause) (
            ('('|WIDTH_LEFT_PAREN) lob_partition_storage (',' lob_partition_storage)* (')'|WIDTH_RIGHT_PAREN)
        )? //TODO ('('|WIDTH_LEFT_PAREN) ( ','? lob_partition_storage)+ (')'|WIDTH_RIGHT_PAREN)
        | xmltype_column_properties
    )+
    ;
...
period_definition
    : {this.isVersion12()}? PERIOD FOR column_name (('('|WIDTH_LEFT_PAREN) start_time_column ',' end_time_column (')'|WIDTH_RIGHT_PAREN))?
    ;
...
identity_options_parentheses
    : identity_options+
    | ('('|WIDTH_LEFT_PAREN) identity_options+ (')'|WIDTH_RIGHT_PAREN)
    ;
...
autogenerated_sequence_definition
    : GENERATED (ALWAYS | BY DEFAULT (ON NULL_)?)? AS IDENTITY (
        ('('|WIDTH_LEFT_PAREN) (sequence_start_clause | sequence_spec)* (')'|WIDTH_RIGHT_PAREN)
    )?
    ;
...
nested_table_col_properties
    : NESTED TABLE (nested_item | COLUMN_VALUE) substitutable_column_clause? (LOCAL | GLOBAL)? STORE AS tableview_name (
        ('('|WIDTH_LEFT_PAREN) (('('|WIDTH_LEFT_PAREN) object_properties (')'|WIDTH_RIGHT_PAREN) | physical_properties | column_properties)+ (')'|WIDTH_RIGHT_PAREN)
...
substitutable_column_clause
    : ELEMENT? IS OF TYPE? ('('|WIDTH_LEFT_PAREN) type_name (')'|WIDTH_RIGHT_PAREN)
    | NOT? SUBSTITUTABLE AT ALL LEVELS
    ;
...
constraint_clauses
    : ADD ('('|WIDTH_LEFT_PAREN) (out_of_line_constraint (',' out_of_line_constraint)* | out_of_line_ref_constraint) (')'|WIDTH_RIGHT_PAREN)
...
check_constraint
    : CHECK ('('|WIDTH_LEFT_PAREN) condition (')'|WIDTH_RIGHT_PAREN) DISABLE?
    ;
...
c_agent_in_clause
    : AGENT IN ('('|WIDTH_LEFT_PAREN) expressions (')'|WIDTH_RIGHT_PAREN)
    ;

c_parameters_clause
    : PARAMETERS ('('|WIDTH_LEFT_PAREN) c_external_parameter (',' c_external_parameter)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
cursor_declaration
    : CURSOR identifier (('('|WIDTH_LEFT_PAREN) parameter_spec (',' parameter_spec)* (')'|WIDTH_RIGHT_PAREN))? (RETURN type_spec)? (
        IS select_statement
    )? ';'
    ;
...
pragma_declaration
    : PRAGMA (
        ...
        | EXCEPTION_INIT ('('|WIDTH_LEFT_PAREN) exception_name ',' numeric_negative (')'|WIDTH_RIGHT_PAREN)
        | INLINE ('('|WIDTH_LEFT_PAREN) id1 = identifier ',' expression (')'|WIDTH_RIGHT_PAREN)
        | RESTRICT_REFERENCES ('('|WIDTH_LEFT_PAREN) (identifier | DEFAULT) (',' identifier)+ (')'|WIDTH_RIGHT_PAREN)
        | DEPRECATE ('('|WIDTH_LEFT_PAREN) identifier ( ',' CHAR_STRING)? (')'|WIDTH_RIGHT_PAREN)
    ) ';'
    ;
...
record_type_def
    : RECORD ('('|WIDTH_LEFT_PAREN) field_spec (',' field_spec)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
varray_type_def
    : (VARRAY | VARYING? ARRAY) ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN) OF type_spec (NOT NULL_)?
    ;
...
cursor_loop_param
    ...
    | record_name IN (cursor_name (('('|WIDTH_LEFT_PAREN) expressions? (')'|WIDTH_RIGHT_PAREN))? | ('('|WIDTH_LEFT_PAREN) select_statement (')'|WIDTH_RIGHT_PAREN))
    ;
...
pipe_row_statement
    : PIPE ROW ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN)
    ;
...
open_statement
    : OPEN cursor_name (('('|WIDTH_LEFT_PAREN) expressions? (')'|WIDTH_RIGHT_PAREN))?
    ;
...
collection_method_call // collection methods invocation that could be used as a statement
    : expression '.' (
        (DELETE | EXTEND) (('('|WIDTH_LEFT_PAREN) index += expression (',' index += expression)* (')'|WIDTH_RIGHT_PAREN))?
        | TRIM (('('|WIDTH_LEFT_PAREN) index += expression (')'|WIDTH_RIGHT_PAREN))?
    )
    ;
...
select_statement
    : select_only_statement (for_update_clause | order_by_clause | limit_clause | offset_clause | fetch_clause)*
    ;
...
subquery_factoring_clause
    : query_name paren_column_list? AS ('('|WIDTH_LEFT_PAREN) subquery order_by_clause? (')'|WIDTH_RIGHT_PAREN) search_clause? cycle_clause?
    ;
...
subav_factoring_clause
    : subav_name = id_expression ANALYTIC VIEW AS ('('|WIDTH_LEFT_PAREN) subav_clause (')'|WIDTH_RIGHT_PAREN)
    ;
...
hierarchies_clause
    : HIERARCHIES ('('|WIDTH_LEFT_PAREN) hier_alias += object_name (',' hier_alias += object_name)* (')'|WIDTH_RIGHT_PAREN)
    ;

filter_clauses
    : FILTER FACT ('('|WIDTH_LEFT_PAREN) filter_clause (',' filter_clause)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
add_calcs_clause
    : ADD MEASURES ('('|WIDTH_LEFT_PAREN) add_calc_meas_clause (',' add_calc_meas_clause)* (')'|WIDTH_RIGHT_PAREN)
    ;

add_calc_meas_clause
    : meas_name = id_expression AS ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN)
    ;
...
subquery_basic_elements
    : query_block
    | ('('|WIDTH_LEFT_PAREN) subquery (')'|WIDTH_RIGHT_PAREN)
    ;
...
query_block
    : SELECT (DISTINCT | UNIQUE | ALL)? selected_list into_clause? from_clause? where_clause? (
        ...
        | group_by_clause
    )* model_clause? order_by_clause? (limit_clause? offset_clause? | offset_clause? limit_clause? ) fetch_clause?
    ;
...
table_ref_aux_internal
    ...
    | ('('|WIDTH_LEFT_PAREN) table_ref subquery_operation_part* (')'|WIDTH_RIGHT_PAREN) (pivot_clause | unpivot_clause)? # table_ref_aux_internal_two
    | ONLY ('('|WIDTH_LEFT_PAREN) dml_table_expression_clause (')'|WIDTH_RIGHT_PAREN)                                    # table_ref_aux_internal_thre
    ;
...
query_partition_clause
    : PARTITION BY ((('('|WIDTH_LEFT_PAREN) (subquery | expressions)? (')'|WIDTH_RIGHT_PAREN)) | expressions)
    ;
...
pivot_clause
    : PIVOT XML? ('('|WIDTH_LEFT_PAREN) pivot_element (',' pivot_element)* pivot_for_clause pivot_in_clause (')'|WIDTH_RIGHT_PAREN)
    ;

pivot_element
    : (numeric_function | aggregate_function_name ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN)) column_alias?
    ;
...
pivot_in_clause
    : IN ('('|WIDTH_LEFT_PAREN) (subquery | ANY (',' ANY)* | pivot_in_clause_element (',' pivot_in_clause_element)*) (')'|WIDTH_RIGHT_PAREN)
    ;
...
pivot_in_clause_elements
    : expression
    | ('('|WIDTH_LEFT_PAREN) expressions? (')'|WIDTH_RIGHT_PAREN)
    ;

unpivot_clause
    : UNPIVOT ((INCLUDE | EXCLUDE) NULLS)? ('('|WIDTH_LEFT_PAREN) (column_name | paren_column_list) pivot_for_clause unpivot_in_clause (')'|WIDTH_RIGHT_PAREN)
    ;

unpivot_in_clause
    : IN ('('|WIDTH_LEFT_PAREN) unpivot_in_elements (',' unpivot_in_elements)* (')'|WIDTH_RIGHT_PAREN)
    ;

unpivot_in_elements
    : (column_name | paren_column_list) (AS (constant | ('('|WIDTH_LEFT_PAREN) constant (',' constant)* (')'|WIDTH_RIGHT_PAREN)))?
    ;
...
rollup_cube_clause
    : (ROLLUP | CUBE) ('('|WIDTH_LEFT_PAREN) grouping_sets_elements (',' grouping_sets_elements)* (')'|WIDTH_RIGHT_PAREN)
    ;

grouping_sets_clause
    : GROUPING SETS ('('|WIDTH_LEFT_PAREN) grouping_sets_elements (',' grouping_sets_elements)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
reference_model
    : REFERENCE reference_model_name ON ('('|WIDTH_LEFT_PAREN) subquery (')'|WIDTH_RIGHT_PAREN) model_column_clauses cell_reference_options*
    ;
...
model_column_list
    : ('('|WIDTH_LEFT_PAREN) model_column (',' model_column)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
model_rules_clause
    : model_rules_part? ('('|WIDTH_LEFT_PAREN) (model_rules_element (',' model_rules_element)*)? (')'|WIDTH_RIGHT_PAREN)
    ;
...
model_iterate_clause
    : ITERATE ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN) until_part?
    ;

until_part
    : UNTIL ('('|WIDTH_LEFT_PAREN) condition (')'|WIDTH_RIGHT_PAREN)
    ;
...
limit_clause
    : LIMIT (expression COMMA)? (expression | ALL) 
    ;
...
update_set_clause
    : SET (
        ...
        | VALUE ('('|WIDTH_LEFT_PAREN) identifier (')'|WIDTH_RIGHT_PAREN) '=' expression
    )
    ;

column_based_update_set_clause
    : column_name '=' expression
    | paren_column_list '=' ( ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN) | subquery )
    ;
...
values_clause
    : VALUES (REGULAR_ID | ('('|WIDTH_LEFT_PAREN) expressions (')'|WIDTH_RIGHT_PAREN) | collection_expression)
    ;

merge_statement
    : MERGE INTO tableview_name table_alias? USING selected_tableview ON ('('|WIDTH_LEFT_PAREN) condition (')'|WIDTH_RIGHT_PAREN) (
...
selected_tableview
    /*: (tableview_name | ('('|WIDTH_LEFT_PAREN) select_statement (')'|WIDTH_RIGHT_PAREN)) table_alias?*/
...
general_table_ref
    : (dml_table_expression_clause | ONLY ('('|WIDTH_LEFT_PAREN) dml_table_expression_clause (')'|WIDTH_RIGHT_PAREN)) table_alias?
    ;
...
dml_table_expression_clause
    ...
    | ('('|WIDTH_LEFT_PAREN) select_statement subquery_restriction_clause? (')'|WIDTH_RIGHT_PAREN)
    | tableview_name hierarchies_clause? sample_clause?
    | json_table_clause (AS identifier)?
    | LATERAL ('('|WIDTH_LEFT_PAREN) subquery subquery_restriction_clause? (')'|WIDTH_RIGHT_PAREN)
    ;

table_collection_expression
    : (TABLE | THE | UNNEST | UNNEST_TABLE) (('('|WIDTH_LEFT_PAREN) subquery (')'|WIDTH_RIGHT_PAREN) | ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN) outer_join_sign?)
    ;
...
sample_clause
    : SAMPLE BLOCK? ('('|WIDTH_LEFT_PAREN) expression (',' expression)? (')'|WIDTH_RIGHT_PAREN) seed_part?
    ;

seed_part
    : SEED ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN)
    ;
...
condition
    : expression
    | JSON_EQUAL ('('|WIDTH_LEFT_PAREN) expressions (')'|WIDTH_RIGHT_PAREN)
    ;

expressions
    : expression ((','|WIDTH_COMMA) expression)*
    ;

expression
    : cursor_expression (TYPECAST type_name)?
    | logical_expression (TYPECAST type_name)?
    ;

cursor_expression
    : CURSOR ('('|WIDTH_LEFT_PAREN) subquery (')'|WIDTH_RIGHT_PAREN)
    ;
...
logical_operation
    : (
        ...
        | A_LETTER SET
        | EMPTY_
        | OF TYPE? ('('|WIDTH_LEFT_PAREN) ONLY? type_spec (',' type_spec)* (')'|WIDTH_RIGHT_PAREN)
...
relational_expression
    ...
    | compound_expression (TYPECAST type_name)?
    ;
...
in_elements
    : ('('|WIDTH_LEFT_PAREN) subquery (')'|WIDTH_RIGHT_PAREN)
    | ('('|WIDTH_LEFT_PAREN) concatenation ((','|WIDTH_COMMA) concatenation)* (')'|WIDTH_RIGHT_PAREN)
    | constant
    | bind_variable
    | general_element
    ;
...
interval_expression
    : DAY (('('|WIDTH_LEFT_PAREN) concatenation (')'|WIDTH_RIGHT_PAREN))? TO SECOND (('('|WIDTH_LEFT_PAREN) concatenation (')'|WIDTH_RIGHT_PAREN))?
    | YEAR (('('|WIDTH_LEFT_PAREN) concatenation (')'|WIDTH_RIGHT_PAREN))? TO MONTH
...
single_column_for_loop
    : FOR column_name (
        IN ('('|WIDTH_LEFT_PAREN) expressions? (')'|WIDTH_RIGHT_PAREN)
...
multi_column_for_loop
    : FOR paren_column_list IN ('('|WIDTH_LEFT_PAREN) (subquery | ('('|WIDTH_LEFT_PAREN) expressions? (')'|WIDTH_RIGHT_PAREN)) (')'|WIDTH_RIGHT_PAREN)
    ;
...
unary_expression
    ...
    | unary_expression '.' (
        ...
        | (EXISTS | NEXT | PRIOR) ('('|WIDTH_LEFT_PAREN) index += expression (')'|WIDTH_RIGHT_PAREN)
    )
...
implicit_cursor_expression
    : SQL (
        PERCENT_BULK_ROWCOUNT ('('|WIDTH_LEFT_PAREN) index = expression (')'|WIDTH_RIGHT_PAREN)
        | PERCENT_BULK_EXCEPTIONS ('.' COUNT | ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN) '.' (ERROR_INDEX | ERROR_CODE))
    )
    ;

collection_expression
    : collation_name ('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN) ('.' general_element_part)*
    ;
...
atom
    ...
    | ('('|WIDTH_LEFT_PAREN) subquery (')'|WIDTH_RIGHT_PAREN) subquery_operation_part*
    | ('('|WIDTH_LEFT_PAREN) expressions (')'|WIDTH_RIGHT_PAREN) (TYPECAST type_name)?
    ;

quantified_expression
    : (SOME | EXISTS | ALL | ANY) (
        ('('|WIDTH_LEFT_PAREN) select_only_statement (')'|WIDTH_RIGHT_PAREN)
        | ('('|WIDTH_LEFT_PAREN) expression (',' expression)* (')'|WIDTH_RIGHT_PAREN)
    )
    ;

string_function
    : SUBSTR ('('|WIDTH_LEFT_PAREN) expression ',' expression (',' expression)? (')'|WIDTH_RIGHT_PAREN)
    | TO_CHAR ('('|WIDTH_LEFT_PAREN) (table_element | standard_function | expression) (',' quoted_string)? (
        ',' quoted_string
    )? (')'|WIDTH_RIGHT_PAREN)
    | DECODE ('('|WIDTH_LEFT_PAREN) expressions (')'|WIDTH_RIGHT_PAREN)
    | CHR ('('|WIDTH_LEFT_PAREN) concatenation USING NCHAR_CS (')'|WIDTH_RIGHT_PAREN)
    | NVL ('('|WIDTH_LEFT_PAREN) expression ',' expression (')'|WIDTH_RIGHT_PAREN)
    | TRIM ('('|WIDTH_LEFT_PAREN) ((LEADING | TRAILING | BOTH)? expression? FROM)? concatenation (')'|WIDTH_RIGHT_PAREN)
    | TO_DATE ('('|WIDTH_LEFT_PAREN) (table_element | standard_function | expression) (
        DEFAULT concatenation ON CONVERSION ERROR
    )? (',' quoted_string (',' quoted_string)?)? (')'|WIDTH_RIGHT_PAREN)
    ;
...
json_function
    : JSON_ARRAY ('('|WIDTH_LEFT_PAREN) json_array_element (',' json_array_element)* json_on_null_clause? json_return_clause? STRICT? (')'|WIDTH_RIGHT_PAREN)
    | JSON_ARRAYAGG ('('|WIDTH_LEFT_PAREN) expression (FORMAT JSON)? order_by_clause? json_on_null_clause? json_return_clause? STRICT? (')'|WIDTH_RIGHT_PAREN)
    | JSON_OBJECT ('('|WIDTH_LEFT_PAREN) json_object_content (')'|WIDTH_RIGHT_PAREN)
    | JSON_OBJECTAGG ('('|WIDTH_LEFT_PAREN) KEY? expression VALUE expression ((NULL_ | ABSENT) ON NULL_)? (
        RETURNING (VARCHAR2 (('('|WIDTH_LEFT_PAREN) UNSIGNED_INTEGER ( BYTE | CHAR)? (')'|WIDTH_RIGHT_PAREN))? | CLOB | BLOB)
    )? STRICT? (WITH UNIQUE KEYS)? (')'|WIDTH_RIGHT_PAREN)
    | JSON_QUERY ('('|WIDTH_LEFT_PAREN) expression (FORMAT JSON)? ',' CHAR_STRING json_query_returning_clause json_query_wrapper_clause? json_query_on_error_clause?
        json_query_on_empty_clause? (')'|WIDTH_RIGHT_PAREN)
    | JSON_SERIALIZE ('('|WIDTH_LEFT_PAREN) CHAR_STRING (RETURNING json_query_return_type)? PRETTY? ASCII? TRUNCATE? (
        (NULL_ | ERROR | EMPTY_ (ARRAY | OBJECT)) ON ERROR
    )? (')'|WIDTH_RIGHT_PAREN)
    | JSON_TRANSFORM ('('|WIDTH_LEFT_PAREN) expression ',' json_transform_op (',' json_transform_op)* (')'|WIDTH_RIGHT_PAREN)
    | JSON_VALUE ('('|WIDTH_LEFT_PAREN) expression (FORMAT JSON)? (
        ',' CHAR_STRING? json_value_return_clause? ((ERROR | NULL_ | DEFAULT literal)? ON ERROR)? (
            (ERROR | NULL_ | DEFAULT literal)? ON EMPTY_
        )? json_value_on_mismatch_clause? (')'|WIDTH_RIGHT_PAREN)
    )?
    ;
...
json_table_clause
    : JSON_TABLE ('('|WIDTH_LEFT_PAREN) expression (FORMAT JSON)? (',' CHAR_STRING)? ((ERROR | NULL_) ON ERROR)? (
        (EMPTY_ | NULL_) ON EMPTY_
    )? json_column_clause? (')'|WIDTH_RIGHT_PAREN)
    ;
...
json_column_clause
    : COLUMNS ('('|WIDTH_LEFT_PAREN) json_column_definition (',' json_column_definition)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
json_query_return_type
    : VARCHAR2 (('('|WIDTH_LEFT_PAREN) UNSIGNED_INTEGER ( BYTE | CHAR)? (')'|WIDTH_RIGHT_PAREN))?
    | CLOB
    | BLOB
    ;
...
json_value_return_type
    : VARCHAR2 (('('|WIDTH_LEFT_PAREN) UNSIGNED_INTEGER ( BYTE | CHAR)? (')'|WIDTH_RIGHT_PAREN))? TRUNCATE?
    | CLOB
    | DATE
    | NUMBER (('('|WIDTH_LEFT_PAREN) INTEGER (',' INTEGER)? (')'|WIDTH_RIGHT_PAREN))?
...
json_value_on_mismatch_clause
    : (IGNORE | ERROR | NULL_) ON MISMATCH (('('|WIDTH_LEFT_PAREN) MISSING DATA | EXTRA DATA | TYPE ERROR (')'|WIDTH_RIGHT_PAREN))?
    ;
...
numeric_function
    : SUM ('('|WIDTH_LEFT_PAREN) (DISTINCT | ALL)? expression (')'|WIDTH_RIGHT_PAREN)
    | COUNT ('('|WIDTH_LEFT_PAREN) (ASTERISK | ((DISTINCT | UNIQUE | ALL)? concatenation)?) (')'|WIDTH_RIGHT_PAREN) over_clause?
    | ROUND ('('|WIDTH_LEFT_PAREN) expression (',' UNSIGNED_INTEGER)? (')'|WIDTH_RIGHT_PAREN)
    | AVG ('('|WIDTH_LEFT_PAREN) (DISTINCT | ALL)? expression (')'|WIDTH_RIGHT_PAREN)
    | MAX ('('|WIDTH_LEFT_PAREN) (DISTINCT | ALL)? expression (')'|WIDTH_RIGHT_PAREN)
    | LEAST ('('|WIDTH_LEFT_PAREN) expressions (')'|WIDTH_RIGHT_PAREN)
    | GREATEST ('('|WIDTH_LEFT_PAREN) expressions (')'|WIDTH_RIGHT_PAREN)
    ;
...
other_function
    ...
    | COUNT ('('|WIDTH_LEFT_PAREN) (ASTERISK | (DISTINCT | UNIQUE | ALL)? concatenation) (')'|WIDTH_RIGHT_PAREN) over_clause?
    | (CAST | XMLCAST) ('('|WIDTH_LEFT_PAREN) ((MULTISET|ARRAY) ('('|WIDTH_LEFT_PAREN) subquery (')'|WIDTH_RIGHT_PAREN) (TYPECAST type_name)? table_alias? | concatenation) AS type_spec (
        DEFAULT concatenation ON CONVERSION ERROR
    )? (',' quoted_string (',' quoted_string)?)? (')'|WIDTH_RIGHT_PAREN)
    | COALESCE ('('|WIDTH_LEFT_PAREN) table_element (',' (numeric | quoted_string))? (')'|WIDTH_RIGHT_PAREN)
    | COLLECT ('('|WIDTH_LEFT_PAREN) (DISTINCT | UNIQUE)? concatenation collect_order_by_part? (')'|WIDTH_RIGHT_PAREN)
    | within_or_over_clause_keyword function_argument within_or_over_part+
    | LISTAGG ('('|WIDTH_LEFT_PAREN) (ALL | DISTINCT | UNIQUE)? argument (',' string_delimiter)? listagg_overflow_clause? (')'|WIDTH_RIGHT_PAREN) (
        WITHIN GROUP ('('|WIDTH_LEFT_PAREN) order_by_clause (')'|WIDTH_RIGHT_PAREN)
    )? over_clause?
    | cursor_name (PERCENT_ISOPEN | PERCENT_FOUND | PERCENT_NOTFOUND | PERCENT_ROWCOUNT)
    | DECOMPOSE ('('|WIDTH_LEFT_PAREN) concatenation (CANONICAL | COMPATIBILITY)? (')'|WIDTH_RIGHT_PAREN)
    | EXTRACT ('('|WIDTH_LEFT_PAREN) regular_id FROM concatenation (')'|WIDTH_RIGHT_PAREN)
    ...
    | standard_prediction_function_keyword ('('|WIDTH_LEFT_PAREN) expressions cost_matrix_clause? using_clause? (')'|WIDTH_RIGHT_PAREN)
    | (TO_BINARY_DOUBLE | TO_BINARY_FLOAT | TO_NUMBER | TO_TIMESTAMP | TO_TIMESTAMP_TZ) ('('|WIDTH_LEFT_PAREN) concatenation (
        DEFAULT concatenation ON CONVERSION ERROR
    )? (',' quoted_string (',' quoted_string)?)? (')'|WIDTH_RIGHT_PAREN)
    | (TO_DSINTERVAL | TO_YMINTERVAL) ('('|WIDTH_LEFT_PAREN) concatenation (DEFAULT concatenation ON CONVERSION ERROR)? (')'|WIDTH_RIGHT_PAREN)
    | TRANSLATE ('('|WIDTH_LEFT_PAREN) expression (USING (CHAR_CS | NCHAR_CS))? (',' expression)* (')'|WIDTH_RIGHT_PAREN)
    | TREAT ('('|WIDTH_LEFT_PAREN) expression AS REF? type_spec (')'|WIDTH_RIGHT_PAREN) ('.' general_element_part)*
    | TRIM ('('|WIDTH_LEFT_PAREN) ((LEADING | TRAILING | BOTH)? quoted_string? FROM)? concatenation (')'|WIDTH_RIGHT_PAREN)
    | VALIDATE_CONVERSION ('('|WIDTH_LEFT_PAREN) concatenation AS type_spec (',' quoted_string (',' quoted_string)?)? (')'|WIDTH_RIGHT_PAREN)
    | XMLAGG ('('|WIDTH_LEFT_PAREN) expression order_by_clause? (')'|WIDTH_RIGHT_PAREN) ('.' general_element_part)*
    | (XMLCOLATTVAL | XMLFOREST) ('('|WIDTH_LEFT_PAREN) xml_multiuse_expression_element (
        ',' xml_multiuse_expression_element
    )* (')'|WIDTH_RIGHT_PAREN) ('.' general_element_part)*
    | XMLELEMENT ('('|WIDTH_LEFT_PAREN) (ENTITYESCAPING | NOENTITYESCAPING)? (NAME | EVALNAME)? expression (
        /*TODO{input.LT(2).getText().equalsIgnoreCase("xmlattributes")}?*/ ',' xml_attributes_clause
    )? (',' expression column_alias?)* (')'|WIDTH_RIGHT_PAREN) ('.' general_element_part)*
    | XMLEXISTS ('('|WIDTH_LEFT_PAREN) expression xml_passing_clause? (')'|WIDTH_RIGHT_PAREN)
    | XMLPARSE ('('|WIDTH_LEFT_PAREN) (DOCUMENT | CONTENT) concatenation WELLFORMED? (')'|WIDTH_RIGHT_PAREN) ('.' general_element_part)*
    | XMLPI ('('|WIDTH_LEFT_PAREN) (NAME identifier | EVALNAME concatenation) (',' concatenation)? (')'|WIDTH_RIGHT_PAREN) (
        '.' general_element_part
    )*
    | XMLQUERY ('('|WIDTH_LEFT_PAREN) concatenation xml_passing_clause? RETURNING CONTENT (NULL_ ON EMPTY_)? (')'|WIDTH_RIGHT_PAREN) (
        '.' general_element_part
    )*
    | XMLROOT ('('|WIDTH_LEFT_PAREN) concatenation (',' xmlroot_param_version_part)? (
        ',' xmlroot_param_standalone_part
    )? (')'|WIDTH_RIGHT_PAREN) ('.' general_element_part)*
    | XMLSERIALIZE ('('|WIDTH_LEFT_PAREN) (DOCUMENT | CONTENT) concatenation (AS type_spec)? xmlserialize_param_enconding_part? xmlserialize_param_version_part?
        xmlserialize_param_ident_part? ((HIDE | SHOW) DEFAULTS)? (')'|WIDTH_RIGHT_PAREN) ('.' general_element_part)?
    | TIME CHAR_STRING
    | xmltable
    ;
...
string_delimiter
    ...
    | ('('|WIDTH_LEFT_PAREN) string_delimiter (')'|WIDTH_RIGHT_PAREN)
    | id_expression
    ;
...
cost_matrix_clause
    : COST (
        MODEL AUTO?
        | ('('|WIDTH_LEFT_PAREN) cost_class_name (',' cost_class_name)* (')'|WIDTH_RIGHT_PAREN) VALUES ('('|WIDTH_LEFT_PAREN) expressions? (')'|WIDTH_RIGHT_PAREN)
    )
    ;
...
xml_attributes_clause
    : XMLATTRIBUTES ('('|WIDTH_LEFT_PAREN) (ENTITYESCAPING | NOENTITYESCAPING)? (SCHEMACHECK | NOSCHEMACHECK)? xml_multiuse_expression_element (
        ',' xml_multiuse_expression_element
    )* (')'|WIDTH_RIGHT_PAREN)
    ;

xml_namespaces_clause
    : XMLNAMESPACES ('('|WIDTH_LEFT_PAREN) (concatenation column_alias)? (',' concatenation column_alias)* xml_general_default_part? (')'|WIDTH_RIGHT_PAREN)
    ;
...
partition_extension_clause
    : (SUBPARTITION | PARTITION) FOR? ('('|WIDTH_LEFT_PAREN) expressions? (')'|WIDTH_RIGHT_PAREN)
    ;
...
quantitative_where_stmt
    : expression relational_operator (SOME | ALL | ANY) ('('|WIDTH_LEFT_PAREN) expression (',' expression)* (')'|WIDTH_RIGHT_PAREN)
    ;
...
xmltable
    : XMLTABLE ('('|WIDTH_LEFT_PAREN) (xml_namespaces_clause ',')? concatenation xml_passing_clause? (
...
paren_column_list
    : (LEFT_PAREN|WIDTH_LEFT_PAREN) column_list (RIGHT_PAREN|WIDTH_RIGHT_PAREN)
    ;
...
keep_clause
    : KEEP ('('|WIDTH_LEFT_PAREN) DENSE_RANK (FIRST | LAST) (query_partition_clause | order_by_clause) (')'|WIDTH_RIGHT_PAREN) over_clause?
    ;

function_argument
    : ('('|WIDTH_LEFT_PAREN) (argument ((','|WIDTH_COMMA) argument)* order_by_clause?)? (')'|WIDTH_RIGHT_PAREN) keep_clause?
    ;

function_argument_analytic
    : ('('|WIDTH_LEFT_PAREN) (argument respect_or_ignore_nulls? (',' argument respect_or_ignore_nulls?)*)? (')'|WIDTH_RIGHT_PAREN) keep_clause?
    ;

function_argument_modeling
    : ('('|WIDTH_LEFT_PAREN) column_name (',' (numeric | NULL_) (',' (numeric | NULL_))?)? USING (
        tableview_name '.' ASTERISK
        | ASTERISK
        | expression column_alias? (',' expression column_alias?)*
    ) (')'|WIDTH_RIGHT_PAREN) keep_clause?
    ;
...
datatype
    ...
    | INTERVAL (YEAR | DAY) (('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN))? TO (MONTH | SECOND) (('('|WIDTH_LEFT_PAREN) expression (')'|WIDTH_RIGHT_PAREN))?
    ;

precision_part
    : ('('|WIDTH_LEFT_PAREN) (numeric | ASTERISK) (',' (numeric | numeric_negative))? (CHAR | BYTE)? (')'|WIDTH_RIGHT_PAREN)
    ;
...
general_element
    ...
    | ('('|WIDTH_LEFT_PAREN) general_element (')'|WIDTH_RIGHT_PAREN)
    ;
...
constant
    ...
    | INTERVAL (quoted_string | bind_variable | general_element_part) (
        ...
        | MINUTE
        | SECOND
    ) (('('|WIDTH_LEFT_PAREN) (UNSIGNED_INTEGER | bind_variable) (',' (UNSIGNED_INTEGER | bind_variable))? (')'|WIDTH_RIGHT_PAREN))? (
        TO (DAY | HOUR | MINUTE | SECOND (('('|WIDTH_LEFT_PAREN) (UNSIGNED_INTEGER | bind_variable) (')'|WIDTH_RIGHT_PAREN))?)
    )?
    | numeric
    | DATE quoted_string
    | quoted_string
...
outer_join_sign
    : ('('|WIDTH_LEFT_PAREN) '+' (')'|WIDTH_RIGHT_PAREN)
    ;
